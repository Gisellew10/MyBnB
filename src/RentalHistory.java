...
public class RentalHistory{
    ...
    public RentalHistory(String Booking_ID, int LID, String UserID, String date, String address, String city, String country, double price, String start_date, String end_date){
